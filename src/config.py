...
# タイトルに含まれていれば「過去年の記事」と判定するパターン。
# Google News RSSはインデックス日をpubDateにするため、本文判定が必要。
# CRITICAL_OVERRIDE該当（リコール等）の場合は除外しない。
PAST_YEAR_TITLE_PATTERNS = [
    "2024年", "2024 年",       # 2024年版/X月/比較等を捕捉
    "2025年", "2025 年",       # 1年以上前は基本ノイズ扱い
    "昨年", "去年", "前年", "一昨年",
]
