...
【鮮度ルール — 厳守】
本日から30日以上前の話題は基本 is_relevant=false にする。

⚠️ Google News RSSは古い記事を再インデックスすると pubDate を最新日に更新する仕様のため、
**published 日付は信用しないこと**。タイトル/要約の本文から実際の年を判定する:

- 記事タイトルや要約の冒頭に「2018年」〜「2025年」が含まれる場合、その年の記事である可能性が高い
- 「ユニ・チャームが2018年に発表した戦略」のような過去事例を語る記事 → is_relevant=false
- 「○○年版」「20XX年X月X日に発表」「20XX年から開始」など過去年が記事の主題になっている → is_relevant=false
- 「昨年」「去年」「前年」「一昨年」も同様 → is_relevant=false
- 例外: 「2018年〜2026年の市場推移」のような時系列分析記事は残してよい（ただし最新トレンド記事として）

published 日付が新しく見えても、本文に上記の過去年シグナルがあれば古い記事として扱う。
